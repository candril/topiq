...
<Aside type="caution">
topiq is young and built spec-first — every feature traces to a numbered spec in
[`specs/`](https://github.com/candril/topiq/tree/main/specs). It *writes*: replay, produce,
offset seek. Every write is off by default per cluster and confirmed at the point of action.
Point it at dev and test clusters first, and expect rough edges.
</Aside>
...
See the [installation guide](/topiq/guide/installation/) for the config and first run.
